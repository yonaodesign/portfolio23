    ...
    <FormWrapper onSubmit={handleSubmit(onSubmit)}>
      ...
      {isProcessing === 'done' ?
        <div>Thank you. I&apos;ve got your message!</div> : (<>
          ...
          <StyledInput type="text" placeholder="Bob" {...register("FullName", {required: true, maxLength: 100})} />
          <StyledLabel>Your Email</StyledLabel>
          <StyledInput type="text" placeholder="bob@abobek.com" {...register("Email", {required: true, pattern: /^\S+@\S+$/i})} />
          <StyledLabel>You Message</StyledLabel>
          <StyledTextArea placeholder="Write your message here." {...register("Message", {required: true, maxLength: 1000})} />
          <StyledButton type="submit" value="Send the message" disabled={isProcessing==='processing'}/>
      </>)}
