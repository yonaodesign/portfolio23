...
{/* NAVIGATION */}
          ...
          <section style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#fff'}}>
                ...
                <CoverImage>
                  <div style={{zIndex: 2, borderRadius: 20,  position: 'absolute', width: '100%', height: '100%', backgroundColor: '#000000', mixBlendMode: 'soft-light', opacity: 0.5}}></div>

                  <div style={{zIndex: 3, borderRadius: 20, width: '100%', height: '100%', backgroundColor: '#000000', mixBlendMode: 'color', opacity: scrollY > 400 ? 0 : 1, transition: '1s'}}></div>
                </CoverImage>
