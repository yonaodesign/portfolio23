const ProjectsData = [
  {
    ...
    fullText: ``,
    projectDescription:
      "<p>Japanible is a web 2 public blogging platform, catering to individuals who have something to say or are interested about Japan, its culture, and language.</p>",
    technicalDescription:
      "<p>The goal of this project was to learn working with Firebase by creating a CRUD application utilizing React.js (CRA).</p>",
...

  {
    ...
    projectAnnotation:
      "A cloud-based PERN stack application for managing, archiving and sharing technical documentation for a sales team.",
  ...
  },
  {
    ...
    projectDesktopPhoto: ["b2bGallery.png"],
  },
  {
    title: "SMOSS",
    projectSlug: "smoss",
  ...
  `,
    cta: [
      {
        type: "link",
        text: "Live site",
        href: "http://www.sensyo-ltd.co.jp",
        aria: "Link to Japanese only website of Japanese Manufacturer called Sensyo Company Limited. Link opens in a new window.",
      },
      {
        type: "link",
        text: "Web archive",
        href: "http://web.archive.org/web/20230401000722/http://sensyo-ltd.co.jp/",
        aria: "Link to an archived version of Japanese only website of Japanese Manufacturer called Sensyo Company Limited. Link opens in a new window.",
      },
    ],
    projectTagLine: "",
    projectAnnotation: "",
    ...
    projectDesktopPhoto: ["sensyoGallery.png"],
  },
    ...
    cta: [
      {
        type: "link",
        text: "Live site",
        href: "http://www.cher.jp/en",
        aria: "Link to a landing page of a brand called PUR CHER. Link opens in a new window.",
      },
    ],
    projectTagLine: "",
    projectAnnotation: "",
